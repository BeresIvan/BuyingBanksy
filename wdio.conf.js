...
exports.config = {
  ...
  jasmineOpts: {
    ...
    // an assertion fails.
    expectationResultHandler: function(_passed, assertion) {
      // do something
    },
    //
  ...
  specs: ["./src/cucumberFeature/**/*.feature"],
  suite: {cucumberFeaturetests:["./src/cucumberFeatures/*.feature"]},
  ...
  cucumberOpts: {
    require: [".src/cucumberFeatures/step*.js/"], // <string[]> (file/dir) require files before executing features
    backtrace: false, // <boolean> show full backtrace for errors
    compiler: ["babel-register"], // <string[]> ("extension:module") require files with the given EXTENSION after requiring MODULE (repeatable)
    ...
    timeout: 60000000, // <number> timeout for step definitions
